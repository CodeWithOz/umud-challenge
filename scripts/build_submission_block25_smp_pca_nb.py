...
OUT_DIR = ROOT / "notebooks/submission-block25-smp-pca"
...
"""
    ...
    (OUT_DIR / "submission-block25-smp-pca.ipynb").write_text(json.dumps(nb, indent=1))
    meta = {
        "id": "ucheozoemena/umud-submission-block25-smp-pca",
        "title": "UMUD Submission Block25 SMP PCA",
        "code_file": "submission-block25-smp-pca.ipynb",
        "language": "python",
