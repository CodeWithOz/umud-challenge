"""Generate notebooks/apo-gray55-eval — MT eval of gray55-trained apo model."""
import json
import sys
...
def main() -> None:
    out = Path(__file__).resolve().parents[1] / "notebooks/apo-gray55-eval"
    ...
    (out / "apo-gray55-eval-phase-3.ipynb").write_text(json.dumps(nb, indent=1))
    meta = {
        "id": "ucheozoemena/umud-apo-gray55-eval-phase-3",
        "title": "UMUD Apo Gray55 Eval Phase 3",
        "code_file": "apo-gray55-eval-phase-3.ipynb",
        "language": "python",
