...
OUT_DIR = ROOT / "notebooks/submission-block29-corrected"
...
SMP_KERNEL_DIR = Path("/kaggle/input/notebooks/ucheozoemena/umud-train-corrected-smp")
...
W = {"pa_deg": 0.50, "fl_mm": 0.35, "mt_mm": 0.40}
...
"""
    ...
    (OUT_DIR / "submission-block29-corrected.ipynb").write_text(json.dumps(nb, indent=1))
    meta = {
        "id": "ucheozoemena/umud-submission-block29-corrected",
        "title": "UMUD Submission Block29 Corrected",
        "code_file": "submission-block29-corrected.ipynb",
        "language": "python",
